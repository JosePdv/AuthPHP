...
<div class="container">
	...
	echo'<h5> Usuario deletado com sucesso</h5>';
}  ?>
	<ul>
		<li><a href="formulario.php"><button class="btn btn-primary btn-sm">Voltar Cadastro </button></a></li>
		<li><a href="lista.php"><button class="btn btn-primary btn-sm">Voltar Lista</button></a></li>
	</ul>
</div>
</div>
